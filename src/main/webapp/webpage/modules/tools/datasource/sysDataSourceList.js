...
$(document).ready(function() {
  ...
  function deleteAll(){
   ...
   function add(){
	  jp.openDialog('新增数据源', "${ctx}/tools/sysDataSource/form",'800px', '500px', $('#sysDataSourceTable'));
  }
  ...
  <shiro:hasPermission name="tools:sysDataSource:edit">
	  jp.openDialog('编辑数据源', "${ctx}/tools/sysDataSource/form?id=" + id,'800px', '500px', $('#sysDataSourceTable'));
  </shiro:hasPermission>
   <shiro:lacksPermission name="tools:sysDataSource:edit">
	  jp.openDialogView('查看数据源', "${ctx}/tools/sysDataSource/form?id=" + id,'800px', '500px', $('#sysDataSourceTable'));
