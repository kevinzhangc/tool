...
<td><a  href="#" onclick="jp.openDialogView('查看区域', '${ctx}/sys/area/form?id={{ d.id }}','800px', '500px')">{{ d.name }}</a></td>
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu" role="menu">
		<shiro:hasPermission name="sys:area:view">
			<li><a href="#" onclick="jp.openDialogView('查看区域', '${ctx}/sys/area/form?id={{ d.id }}','800px', '500px')"  ><i class="fa fa-search-plus"></i>  查看</a></li>
		</shiro:hasPermission>
		<shiro:hasPermission name="sys:area:edit">
			<li><a href="#" onclick="jp.openDialog('修改区域', '${ctx}/sys/area/form?id={{ d.id }}','800px', '500px', $treeTable)" ><i class="fa fa-edit"></i> 修改</a></li>
		</shiro:hasPermission>
		...
		<shiro:hasPermission name="sys:area:add">
			<li><a href="#" onclick="jp.openDialog('添加下级区域', '${ctx}/sys/area/form?parent.id={{ d.id }}','800px', '500px', $treeTable)"><i class="fa fa-plus"></i> 添加下级区域</a></li>
		</shiro:hasPermission>
	  </ul>
	</div>
</td>
