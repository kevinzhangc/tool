...
<head>
	...
	<script type="text/javascript">
        ...
        function addGroup(){
            jp.openDialog("创建群组","${ctx}/iim/layGroup/form","800px", "500px", refreshGroups);
        ...
        function editGroup(id) {
            jp.openDialog("创建群组","${ctx}/iim/layGroup/form?id="+id,"800px", "500px", refreshGroups);

        }
        function viewGroupMember(id) {
           jp.openDialogView("查看群成员","${ctx}/iim/layGroup/member-view?id="+id,"800px", "500px");

        }
        function editGroupMember(id) {
            jp.openDialogView("查看群成员","${ctx}/iim/layGroup/member-edit?id="+id,"800px", "500px");
