...
public class ScheduleJobController extends BaseController {
	...
	public String save(ScheduleJob scheduleJob, Model model, RedirectAttributes redirectAttributes) throws Exception{
		...
		return "redirect:"+Global.getAdminPath()+"/monitor/scheduleJob/?repage";
	}
