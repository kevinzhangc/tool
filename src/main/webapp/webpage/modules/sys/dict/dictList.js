...
$(document).ready(function() {
                ...
                columns: [{
                    ...
                    events: {
        		        'click .view': function (e, value, row, index) {
        		        	jp.openDialogView('查看字典', '${ctx}/sys/dict/form?id=' + row.id,'800px', '500px');
        		        },
        		        'click .edit': function (e, value, row, index) {
        		        	jp.openDialog('编辑字典', '${ctx}/sys/dict/form?id=' + row.id,'800px', '500px');
        		        },
  ...
  function add(){
	  jp.openDialog('新建字典', '${ctx}/sys/dict/form','800px', '500px')
  }
  ...
  function edit(id){
	  ...
	  jp.openDialog('编辑字典', "${ctx}/sys/dict/form?id=" + id,'800px', '500px')
...
$(document).ready(function() {
	var $dictValueTable =	$('#dictValueTable').bootstrapTable({
                ...
                columns: [{
                    ...
                    events: {
                    	 'click .edit': function (e, value, row, index) {
                    		 ...
                    		 jp.openDialog('编辑键值', '${ctx}/sys/dict/dictValueForm?dictTypeId=' + $("#dictTypeId").val()+"&dictValueId="+row.id,'800px', '500px', $dictValueTable);
            		        },
        		        'click .del': function (e, value, row, index) {
		  ...
		  $("#dictValueButton").click(function(){
				...
				jp.openDialog('添加键值', '${ctx}/sys/dict/dictValueForm?dictTypeId=' + $("#dictTypeId").val(),'800px', '500px', $dictValueTable);
			});
