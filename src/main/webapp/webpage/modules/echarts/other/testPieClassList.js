...
$(document).ready(function() {
  ...
  function deleteAll(){
   ...
   function add(){
	  jp.openDialog('新增学生', "${ctx}/echarts/other/testPieClass/form",'800px', '500px',  refreshCharts);
  }
  function edit(id){//没有权限时，不显示确定按钮
	  ...
	  jp.openDialog('编辑学生', "${ctx}/echarts/other/testPieClass/form?id=" + id,'800px', '500px', refreshCharts);
	   </shiro:hasPermission>
	  <shiro:lacksPermission name="echarts:other:testPieClass:edit">
	  jp.openDialogView('查看学生', "${ctx}/echarts/other/testPieClass/form?id=" + id,'800px', '500px', refreshCharts);
